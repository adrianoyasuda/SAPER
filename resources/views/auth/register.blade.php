            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="registro" class="col-md-4 col-form-label text-md-right">{{ __('Matrícula/SIAP') }}</label>

                            <div class="col-md-6">
                                <input id="registro" type="number" class="form-control @error('registro') is-invalid @enderror" name="registro" value="{{ old('registro') }}" required autocomplete="registro">
